...
class Cluster():
    ...
    def read_csv(self, filename, delimiter=",", header=False, missing_value=False, datatype="numeric", matrix=[0,0,0]):
    ...
    def normalize_data(self, feature_range=(0,1), write_original=False):
        ...
        #self.data = min_max_scaler.fit_transform(self.data) come_here
        self.data=preprocessing.normalize(self.data,norm='l1',axis=0)
        self.data = [[round(100*v, 3) for v in row] for row in self.data]
...
def _process_(arguments):
    c = Cluster()
    c.read_csv(arguments.data_file, arguments.data_delimiter, arguments.data_header, arguments.missing_values, arguments.datatype, arguments.data_matrix)
    ...
    if arguments.output_file or arguments.html_dir:
        ...
        return([d.dendrogram,d.data])

class arguments:
    def __init__(self, MATRIX, output_file):
        self.alternative_data=None
        self.alternative_data_compressed_value='median'
        self.alternative_data_delimiter=','
        self.alternative_data_header=False
        self.axis='both'
        self.column_distance='euclidean'
        self.column_linkage='ward'
        self.column_metadata=None
        self.column_metadata_delimiter=','
        self.column_metadata_header=True
        self.compress=0
        self.compressed_value='mean'
        self.data_delimiter=','
        self.data_file=None
        self.data_matrix=MATRIX
        self.data_header=True
        self.datatype='numeric'
        self.dont_write_data=False
        self.html_dir=None
        self.metadata=None
        self.metadata_compressed_value='mean'
        self.metadata_delimiter=','
        self.metadata_header=True
        self.missing_values=False
        self.normalize=True
        self.output_file=None
        self.row_distance='euclidean'
        self.row_linkage='ward'
        self.write_original=True


def main(MATRIX,output_file):
    args = arguments(MATRIX,output_file);
