...
while 1:
	try:
		...
		for job in jobs:
			...
			print json.dumps({"Pipeline":pip, "sampleID":sid,"ProjectID":data['pid'],"UserID":uid,"Status":status, "from":fromf, "tof":tof, "jobid":jid, "user": USER['user_name'], "sample": SAMPLE}, indent=4)
