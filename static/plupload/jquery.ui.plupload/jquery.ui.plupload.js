	...
	*/
	...
	_addFormFields: function() {
		...
		plupload.each(this.uploader.files, function(file, count) {
			...
			if (file.target_name) {
				fields += '<input type="hidden" upload_dir="uploads" name="' + id + '_tmpname" value="'+plupload.xmlEncode(file.target_name)+'" />';
			}
			fields += '<input type="hidden" upload_dir="uploads" name="' + id + '_name" value="'+plupload.xmlEncode(file.name)+'" />';
			fields += '<input type="hidden" upload_dir="uploads" name="' + id + '_status" value="' + (file.status === plupload.DONE ? 'done' : 'failed') + '" />';
