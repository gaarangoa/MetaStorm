window.onload = function() {
    ...
    $.ajax({
        ...
        async: true,
        data: JSON.stringify({
            sql: 'select * from jobs where pid="' + pid + '" and pip="' + pip + '" and uid="' + uid + '" order by strftime(date) '
        }),
        contentType: "application/json; charset=utf-8",
        success: function(x) {
            //console.log(x.data)
    ...
    $.ajax({
        ...
        async: true,
        data: JSON.stringify({
            sql: 'select reference_id, reference_name, status from reference where user_id="' + uid + '"'
        }),
        contentType: "application/json; charset=utf-8",
        success: function(x) {
            //console.log(x.data)
