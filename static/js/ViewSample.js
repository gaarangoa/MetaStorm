window.onload = function() {
    ...
    $.ajax({
        ...
        success: function(x) {
            ...
            $('#updateSampleF1').append(
                '<a href="#" onclick="download_f([1, pid,' +
                "'" +
                x.data[0].reads1 +
                "'" +
                ', sid, uid, 1])" ><i class="fa fa-fw fa-download"></i><b>FastQ1 </b></a><br>'
            );
            $('#updateSampleF2').append(
                '<a href="#" onclick="download_f([1, pid,' +
                "'" +
                x.data[0].reads2 +
                "'" +
                ', sid, uid, 2])" ><i class="fa fa-fw fa-download"></i><b>FastQ2 </b></a><br>'
            );

            if (pip == 'assembly') {
                $('#Dscaffolds').append(
                    '<a href="#" onclick="download_f([2, pid,' +
                    "'scaffolds.fa'" +
                    ', sid, uid, 1])" ><i class="fa fa-fw fa-download"></i><b>Scaffolds </b></a><br>'
                );
                $('#Dgenes').append(
                    '<a href="#" onclick="download_f([3, pid,' +
                    "'pred.genes.fa'" +
                    ', sid, uid, 2])" ><i class="fa fa-fw fa-download"></i><b>Genes </b></a><br>'
                );
            }
        }
    });
    ...
    download_f = function(x) {
        ...
        if (x[0] == 1) {
            ...
            $('#updateSampleF' + x[5]).append(
                "<div class='overlay' id='updateSampleF" +
                x[5] +
                "_overlay'><i class='fa fa-refresh fa-spin'></i></div>"
            );
        }
        ...
        if (x[0] == 2) {
            ...
            $('#Dscaffolds').append(
                "<div class='overlay' id='Dscaffolds_overlay'><i class='fa fa-refresh fa-spin'></i></div>"
            );
        }
        ...
        if (x[0] == 4) {
            ...
            console.log(file);
            $('#download_function_alignment').append(
                "<div class='overlay' id='Dgenes_overlay'><i class='fa fa-refresh fa-spin'></i></div>"
            );
        }

        if (x[0] == 5) {
            // alignment: read-matching
    ...
    var breakdown = function(dataset) {
        ...
        $.ajax({
            ...
            success: function(x) {
                ...
                $('#sfReads').html(parseInt(x.matrix[5].split(' ')[4]).toLocaleString());
                $('#hqReads').html(
                    parseInt(x.matrix[5].split(' ')[7]).toLocaleString() +
        ...
        $('#btn05').click(function(e) {
            ...
            window.location.href =
                ...
                Base64.encode(
                    ...
                    'pred.genes.' +
                    rid +
                    '.matches.taxonomy.abundance.rpkm'
                );
        });
        ...
        $('#btn06').click(function(e) {
            ...
            window.location.href =
                ...
                Base64.encode(
                    ...
                    'pred.genes.' +
                    rid +
                    '.matches.taxonomy.genes.abundance.rpkm'
                );
        });
        ...
        $('#fbtn05').click(function(e) {
            ...
            window.location.href =
                ...
                Base64.encode(
                    ...
                    'pred.genes.' +
                    rid +
                    '.matches.function.abundance.rpkm'
                );
        });
        ...
        $('#fbtn06').click(function(e) {
            ...
            window.location.href =
                ...
                Base64.encode(
                    ...
                    'pred.genes.' +
                    rid +
                    '.matches.function.genes.abundance.rpkm'
                );
        });
        ...
        $('#fbtn02').click(function(e) {
            ...
            window.location.href =
                ...
                Base64.encode(
                    ...
                    'alignment.' +
                    rid +
                    '.matches.function.abundance.16s'
                );
        });
        ...
        $('#fbtn04').click(function(e) {
            ...
            window.location.href =
                ...
                Base64.encode(
                    ...
                    'alignment.' +
                    rid +
                    '.matches.function.genes.abundance.16s'
                );
        });
        ...
        $('#btn03').click(function(e) {
            ...
            window.location.href =
                ...
                Base64.encode(
                    ...
                    'alignment.' +
                    rid +
                    '.matches.taxonomy.abundance.genes.rpkm'
                );
        });
    }
};